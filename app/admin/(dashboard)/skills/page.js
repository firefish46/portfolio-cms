...
export default function AdminSkills() {
 ...
 <div className="skills-layout">
      ...
      {/* LEFT: FORM SECTION */}
      <section className=" skills-form-panel">
        <h2>🚀 Add Technical Skill</h2>

        {/* ICON PREVIEW BOX */}
        <div className="skills-icon-preview">
          <i className={`${formData.icon} fa-4x`}></i>
          <p className="skills-icon-class-label">CLASS: {formData.icon}</p>
        </div>

        <form onSubmit={handleAdd} className="skills-form">
          ...
          <div className="skills-select-row">
            <div className="skills-select-group">
          ...
          <button type="submit" disabled={loading} className="skills-submit-btn">
      ...
      <section className=" skills-list-panel">
        <h2>Current Stack ({skills.length})</h2>
            ...
            <div key={skill._id} className=" skill-card">
              <div className="skill-card-left">
                <div className="skill-card-icon">
                  <i className={`${skill.icon || 'fa-solid fa-code'} fa-xl`}></i>
                </div>
                <div className="skill-card-info">
                  <b className="skill-card-name">{skill.name}</b>
      ...
      {deletingId && (
        <div className="skills-modal-overlay">
          <div className=" skills-modal-card">
            ...
            <div className="skills-modal-actions">
              <button
                ...
                className="skills-modal-btn skills-modal-btn-cancel"
              >
                Keep it
              </button>
              <button
                onClick={executeDelete}
                className="skills-modal-btn skills-modal-btn-delete"
              >
                Delete
              </button>
            </div>
